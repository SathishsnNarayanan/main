...
@Component({
  selector: 'app-syllabus-tree',
  templateUrl: './syllabus-tree.component.html',
  styleUrls: ['./syllabus-tree.component.scss'],
})
export class SyllabusTreeComponent implements OnInit {
  ...
  sample_data: any = [
    {
      ...
      user_category_name: 'POLYTECHNIC COLLEGE',
